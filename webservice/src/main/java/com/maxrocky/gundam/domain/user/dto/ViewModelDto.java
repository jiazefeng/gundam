...
public class ViewModelDto {
    ...
    private List<Viewmodel> allchildMenuList;//所有子菜单

    private List<SecondViewModel> childMenuList;//二级菜单集合
    ...
    public List<SecondViewModel> getChildMenuList() {
        return childMenuList;
    }

    public void setChildMenuList(List<SecondViewModel> childMenuList) {
    ...
    public List<Viewmodel> getAllchildMenuList() {
        return allchildMenuList;
    }

    public void setAllchildMenuList(List<Viewmodel> allchildMenuList) {
        this.allchildMenuList = allchildMenuList;
    }
}
